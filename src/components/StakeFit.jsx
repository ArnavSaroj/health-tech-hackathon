...
import React, { useState } from "react";
import VideoChallengeSquat from "./VideoChallengeSquat";
import VideoChallengePushup from "./VideoChallengePushup";
import "./StakeFit.css";

const StakeFit = () => {
  const [gameMode, setGameMode] = useState("setup"); // 'setup' | 'active'
  const [config, setConfig] = useState({
    workoutType: "squat",
    duration: 30,
    targetReps: 15,
